<script>
    import { coalitionToken, isAuthenticated } from '$lib/api/api'; // Adjust import path if needed
    ...
    // Subscribe to coalitionToken store
...
<section class="bg-white dark:bg-gray-900">
    <div class="py-6 px-4 mx-auto max-w-screen-md">
        ...
        {#if authenticated}
            ...
            {/if}
        {/if}
        <p class="text-yellow-500 text-xl">Now Go To Login of Necuron SDK</p>
    </div>
</section>