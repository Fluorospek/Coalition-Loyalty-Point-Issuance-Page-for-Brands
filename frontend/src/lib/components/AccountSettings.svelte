                    ...
                    <tbody>
                        {#if brandData}
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-600">
                                <td class="px-5 py-5 border-b border-gray-200 dark:border-gray-600 bg-white dark:text-white dark:bg-gray-800 text-md">
                                    Brand ID
                                </td>
                                <td class="px-5 py-5 border-b border-gray-200 dark:border-gray-600 bg-white dark:text-white dark:bg-gray-800 text-md">
                                    {brandData.brandId}
                        ...
                        {#if userData}
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-600">
                                <td class="px-5 py-5 border-b border-gray-200 dark:border-gray-600 dark:text-white bg-white dark:bg-gray-800 text-md">
                                    Name
                                </td>
                                <td class="px-5 py-5 border-b border-gray-200 dark:border-gray-600 dark:text-white bg-white dark:bg-gray-800 text-md">
                                    {userData.name}
